...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=c,c#,c++,css3,dart,html5,java,javascript,ocaml,python,assemblyscript,firebase,.net,flask,sqlite,mysql,mongodb,mariadb,react
